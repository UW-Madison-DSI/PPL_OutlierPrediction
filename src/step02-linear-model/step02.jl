...
|==============================================================================|
|                                                                              |
|        This step fits a probabilistic linear model to the data and           |
|        and displays a plot of the data and the linear model.                 |
|                                                                              |
...
# Main
show(VizGenModel(Linear_regression_with_outliers),"step02_test.png")
